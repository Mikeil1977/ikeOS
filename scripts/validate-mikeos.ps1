...
$requiredTerms = @{
    ...
    'dashboard/pulse/index.html' = @('MikeOS Pulse', 'Evidence -> Entity -> Asset / Obligation -> View', 'Life Admin', 'data-landing="control-room"', 'scene-stage', 'scene-art')
    'dashboard/pulse/pulse.css' = @('.scene-stage', '.scene-art', 'aspect-ratio: 1586 / 884', 'data-zone')
